...
class MainController < ApplicationController
  ...
  def vote(number_of_times, randomize)
    ...
    agent.get "https://docs.google.com/forms/d/1XnhCLV_BKFUD9vOcJdtskRzjpCHap__sp_vhyqwJvjo/viewform"
    # agent.get("https://docs.google.com/forms/d/19FfLH0u7x4L13Uh-BoEFmnCybM4WMWG6jprDNDtrVZE/viewform")
